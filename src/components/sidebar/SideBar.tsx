            ...
            <nav className="h-full sticky flex flex-col bg-mainBlack">
                ...
                <div className="mt-4 px-5">
                    <ul className="space-y-4 text-gray-300">
                        ...
                        <li className="flex items-center justify-between px-2 ">
                            <div className="flex items-center  cursor-pointer hover:text-white">
                                <MessageSquareText size={iconSize} className="mr-2" />
                                <span>Comments</span>
                            </div>
                        </li>
                    </ul>
                ...
                <div className="flex-1 flex flex-col">
                    <h1 className="text-gray-400 text-center mt-4">Questions</h1>
                    <ul className="p-2 pb-4 text-gray-300 text-sm">
                        <li className="flex items-center justify-between p-2 pb-4">
                            <div className="flex items-center hover:text-white">
                                <Dot className="mr-2" />
                                <span className="cursor-pointer ">First question</span>
                            </div>
                        </li>
                        <li className="flex items-center justify-between p-2 pb-4">
                            <div className="flex items-center hover:text-white">
                                <Dot className="mr-2" />
                                <span className="cursor-pointer ">Second looong question</span>
                            </div>
                        </li>
                        <li className="flex items-center justify-between p-2 pb-4">
                            <div className="flex items-center hover:text-white">
                                <Dot className="mr-2" />
                                <span className="cursor-pointer ">Third looong question</span>
                            </div>
                        </li>
                        <li className="flex items-center justify-between p-2 pb-4">
                            <div className="flex items-center hover:text-white">
                                <Dot className="mr-2" />
                                <span className="cursor-pointer ">Fourth veryyyyy looong question</span>
                            </div>
                        </li>
                        <li className="flex items-center justify-between p-2 pb-4">
                            <div className="flex items-center  hover:text-white">
                                <Dot className="mr-2" />
                                <span className="cursor-pointer">Fifth looong question</span>
                            </div>
                        </li>
                    </ul>
                </div>
