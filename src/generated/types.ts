...
export function useGetThemesSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetThemesQuery, GetThemesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetThemesQuery, GetThemesQueryVariables>(GetThemesDocument, options);
        }
